...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_master_transport_agent', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('transport_vehicle', 50)->nullable();
    ...
    {
        Schema::dropIfExists('tbl_master_transport_agent');
    }
};
