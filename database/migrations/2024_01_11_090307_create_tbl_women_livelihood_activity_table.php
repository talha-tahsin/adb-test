...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_women_livelihood_activity', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('women_involved_scope_activities', 20)->nullable();
    ...
    {
        Schema::dropIfExists('tbl_women_livelihood_activity');
    }
};
