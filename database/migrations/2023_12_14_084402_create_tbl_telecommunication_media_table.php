...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_telecommunication_media', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('facilities_type', 150)->nullable();
    ...
    {
        Schema::dropIfExists('tbl_telecommunication_media');
    }
};
