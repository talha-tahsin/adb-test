...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_agroforestry_farming_system', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('agro_forestry_system', 200)->nullable();
    ...
    {
        Schema::dropIfExists('tbl_agroforestry_farming_system');
    }
};
