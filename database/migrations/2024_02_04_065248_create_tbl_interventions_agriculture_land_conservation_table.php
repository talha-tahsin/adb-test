...
return new class extends Migration
{
    ...
    {
        Schema::create('tbl_interventions_agriculture_land_conservation', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('tbl_interventions_agriculture_land_conservation');
    }
};
