...
class BepariController extends Controller
{
    public function entry_kii_bepari()
    {
        return view('kii_checklist.entry_kii_bepari'); 
    }
    public function store_kii_bepari_info(Request $request)
    {
        ...
        try 
        {
            ...
            $store_data1 = array(
                ...
                'bepari_name' => $value->bepari_name,
                'bepari_cell_no' => $value->bepari_cell_no,
                'age' => $value->age,
                'gender' => $value->gender,
            ...
            DB::table('tbl_master_bepari')->insert($store_data1);
            DB::commit();
            ...
            foreach ($xmlstr->row as $value) 
            {
                ...
                DB::table('tbl_bepari_info')->insert($store_data2);
                DB::commit();
            }
            ...
            foreach ($xmlstr2->row as $value) 
            {
                ...
                DB::table('tbl_bepari_questionnaire')->insert($store_data3);
                DB::commit();
            }
