...
{
    public function entry_transport_agent()
    {
        return view('kii_checklist.entry_transport_agent'); 
    }
    public function store_transport_agent_info(Request $request)
    {
        ...
        try 
        {
            ...
            $store_data1 = array(
                ...
                'transport_vehicle' => $value->transport_vehicle,
                'created_by' => $value->created_by,
                'created_at' => $created_at,
            );
            
            DB::table('tbl_master_transport_agent')->insert($store_data1);
            DB::commit();
            ...
            foreach ($xmlstr->row as $value) 
            {
                ...
                DB::table('tbl_transport_agent_info')->insert($store_data2);
                DB::commit();
            }
            ...
            foreach ($xmlstr2->row as $value) 
            {
                ...
                DB::table('tbl_transport_agent_questionnaire')->insert($store_data3);
                DB::commit();
            }
