...
{
    public function entry_super_shop_customer()
    {
        return view('kii_checklist.entry_super_shop_customer'); 
    }
    public function store_super_shop_customer_info(Request $request)
    {
        ...
        try 
        {
            ...
            DB::table('tbl_master_super_shop_customer')->insert($store_data1);
            DB::commit();
            ...
            foreach ($xmlstr2->row as $value) 
            {
                ...
                DB::table('tbl_super_shop_customer_questionnaire')->insert($store_data3);
                DB::commit();
            }
