...
class ProcessingAgentController extends Controller
{
    public function entry_processing_agent()
    {
        return view('kii_checklist.entry_processing_agent'); 
    }
    public function store_processing_agent_info(Request $request)
    {
        ...
        try 
        {
            ...
            DB::table('tbl_master_processing_agent')->insert($store_data1);
            DB::commit();
            ...
            foreach ($xmlstr->row as $value) 
            {
                ...
                DB::table('tbl_processing_agent_info')->insert($store_data2);
                DB::commit();
            }
            ...
            foreach ($xmlstr2->row as $value) 
            {
                ...
                DB::table('tbl_processing_agent_questionnaire')->insert($store_data3);
                DB::commit();
            }
