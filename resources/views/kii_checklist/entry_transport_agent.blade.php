...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">KII with Transport Agent</h1>
          </div><!-- /.col -->
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2" style="margin: 0px 0px 10px 0px;">
                    <label class="control-label"><span style="color: red;">★&nbsp;</span>Transport vehicle</label>
                    <input type="text" name="transport_vehicle" id="transport_vehicle" class="form-control initialVal" style="border-radius: 5px;border: 2px solid #898AEE;padding: 0px 15px 0px 15px;"  value="" placeholder="Please fill up this feild">
                  </div>
              ...
              <div class="col-md-12" style="margin: 20px 0px 10px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label1">Total tax and other fees in BDT</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label2">Extortion amount in BDT</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label3">Destinations (state the location name)</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label4">Carrying capacity (ton) of transport vehicle</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label5">Other challenges faced</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label6">Any capacity development need? (state preferred 5 topics)</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
              ...
              <div class="row">
                ...
                <div class="col-md-4" style="margin: 0px 0px 10px 0px;">
                  <div class="direct-chat-text">
                        <span style="color: #f86d06;">Transport Agent Entry end, thank you! &nbsp; Go To: &nbsp; </span>
...
<!-- this page js -->
<script src="{{ asset('scripts/kii_checklist/entry_transport_agent.js') }}"></script>
<!-- datepicker -->
<script src="{{ asset('plugins/datepicker/jquery-ui.js') }}"></script>

<script>

document.title = 'Transport Agent';
