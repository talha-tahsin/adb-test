...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">KII Checklist for Input Supplier</h1>
          </div><!-- /.col -->
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2" style="margin: 0px 0px 10px 0px;">
                    <label class="control-label"><span style="color: red;">★&nbsp;</span>Distance (km) of Supplier Shop </label>
                    <input type="text" name="distanceOf_supplier" id="distanceOf_supplier" class="form-control initialVal" style="border-radius: 5px;border: 2px solid #898AEE;padding: 0px 15px 0px 15px;"  value="" placeholder="Supplier shop from the Para">
                  </div> 
                ...
                <div class="row">
                  ...
                  <div class="row">
                    <div class="col-md-12" style="margin: 0px 0px 0px 10px;">
                      <label class="control-label">Name of Inputs in the Shop</label>
                      <div class="form-group">
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Seeds">
                          <label class="form-check-label">Seeds</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Fertilizers">
                          <label class="form-check-label">Fertilizers</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Seedlings">
                          <label class="form-check-label">Seedlings</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Pesticides/Disinfects">
                          <label class="form-check-label">Pesticides/Disinfects</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Fungicides">
                          <label class="form-check-label">Fungicides</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Tools">
                          <label class="form-check-label">Tools</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Machinery">
                          <label class="form-check-label">Machinery</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Feed">
                          <label class="form-check-label">Feed</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Supplements">
                          <label class="form-check-label">Supplements</label>
                        </div>
                        <div class="form-check">
                          <input class="form-check-input" type="checkbox" name="type1" value="Medicine">
              ...
              <div class="col-md-12" style="margin: 20px 0px 10px 0px;">
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label1">Reasons for the increase in the price hikes</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <select type="text" id="answer1" class="form-control resetSelect" value="" style="border-radius: 5px;border:2px solid #898AEE;">
                      <option value="" selected disabled> Select Option</option>
                      <option value="Increase in transportation cost">Increase in transportation cost</option> 
                      <option value="Increase in supply shortage">Increase in supply shortage</option> 
                      <option value="Extortion">Extortion</option> 
                      <option value="Higher demand than usual">Higher demand than usual</option> 
                      <option value="Political reason">Political reason</option> 
                    </select>
                  </div>
                </div>
                ...
                <div class="row">
                  <label class="control-label col-md-12" id="label3">Problems and impediments that hinder the adoption of organic measures (rank)</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                  <select type="text" id="answer3" class="form-control resetSelect" value="" style="border-radius: 5px;border:2px solid #898AEE;">
                      ...
                      <option value="supply shortage/unavailability">supply shortage/unavailability</option> 
                      <option value="Lack of training">Lack of training</option> 
                      <option value="increase in production cost">increase in production cost</option> 
                      <option value="Ineffective or less effective">Ineffective or less effective</option>  
                    </select>
                  </div>
                </div> 

                <div class="row">
                  <label class="control-label col-md-12" id="label4">Any capacity development need? (state preferred 5 topics)</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
              ...
              <div class="row">
                ...
                <div class="col-md-4" style="margin: 0px 0px 10px 0px;">
                  <div class="direct-chat-text">
                        <span style="color: #f86d06;">Input Supplier Entry end here, thank you! &nbsp; Go To: &nbsp; </span>
...
<!-- this page js -->
<script src="{{ asset('scripts/kii_checklist/entry_input_supplier.js') }}"></script>
<!-- datepicker -->
<script src="{{ asset('plugins/datepicker/jquery-ui.js') }}"></script>

<script>

document.title = 'Input Supplier';
