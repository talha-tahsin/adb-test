...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">KII Checklist for Bepari</h1>
          </div><!-- /.col -->
            ...
            <div class="card card-primary card-outline">
              <div class="card-body">
                ...
                <div class="row">
                  ...
                  <div class="col-md-2" style="margin: 0px 0px 10px 0px;">
                    <label class="control-label"><span style="color: red;">★&nbsp;</span>Bepari Name</label>
                    <input type="text" name="bepari_name" id="bepari_name" class="form-control initialVal" style="border-radius: 5px;border: 2px solid #898AEE;padding: 0px 15px 0px 15px;"  value="" placeholder="Please fill up this feild">
                  </div>
                ...
                <div class="row">
                  <div class="col-md-2" style="margin: 0px 0px 10px 0px;">
                    <label class="control-label"><span style="color: red;">★&nbsp;</span>Bepari Cell No</label>
                    <input type="text" name="bepari_cell_no" id="bepari_cell_no" class="form-control initialVal" style="border-radius: 5px;border: 2px solid #898AEE;padding: 0px 15px 0px 15px;"  value="" placeholder="Please fill up this feild">
                  </div>
              ...
              <div class="col-md-12" style="margin: 20px 0px 10px 0px;">
                ...
                <div class="row">  
                  <label class="control-label col-md-12" id="label1">Do you make any processing or value additions?</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <select type="text" id="product_processing" class="form-control resetSelect" value="" style="border-radius: 5px;border:2px solid #898AEE;">
                      <option value="" selected disabled> Select Option</option>
                ...
                <div class="row hide" id="input1">
                  <label class="control-label col-md-12">If Yes, write cost (BDT) of per unit product processing or value addition?</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <input type="text" id="cost_of_perUnit_processing" name="cost_of_perUnit_processing" class="form-control initialVal" placeholder="Please write as relevent to the question" style="border-radius: 5px;border:2px solid #898AEE;">
                  </div>
                </div>
             
                <div class="row">
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <label class="control-label" id="label2">From where do you source the products?</label>
                    <input type="text" id="product_source" name="product_source" class="form-control initialVal" placeholder="Please write as relevent to the question" style="border-radius: 5px;border:2px solid #898AEE;">
                  </div>
                </div>
                
                <div class="row">
                <label class="control-label col-md-12" id="label3">Do you supply products to supermarkets or other private sector companies?</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <input type="text" id="supply_terget" name="supply_terget" class="form-control initialVal" placeholder="If, yes, please write down name" style="border-radius: 5px;border:2px solid #898AEE;">
                  </div>
                </div>

                <div class="row">
                <label class="control-label col-md-12" id="label4">Amount of product wastage and spoilage (in kg) per unit product</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <input type="text" id="product_wastage" name="product_wastage" class="form-control initialVal" placeholder="Please write as relevent to the question" style="border-radius: 5px;border:2px solid #898AEE;">
                  </div>
                </div>

                <!-- <div class="row">
                  <div class="col-md-4" style="margin: 0px 0px 0px 0px;">
                    <label class="control-label" id="label7">What is the nature and extent of the Grading for the primary product?</label>
                    <div class="form-group">
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="type1" value="No grading, sell overall bulk">
                        <label class="form-check-label">No grading, sell overall bulk</label>
                      </div>
                      <div class="form-check">
                        <input class="form-check-input" type="checkbox" name="type1" value="Some Bepari do grading others do not">
                        <label class="form-check-label">Some Bepari do grading others do not</label>
                      </div>
                      <div class="form-check">
                ...
                <label id="label5">What is the nature and extent of the Grading for the primary product?</label>
                <div class="row">
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <select type="text" id="gardingOf_product" class="form-control resetSelect" value="" style="border-radius: 5px;border:2px solid #898AEE;">
                      <option value="" selected disabled> Select Option </option>
                      <option value="No grading, sell overall bulk">No grading, sell overall bulk</option>
                      <option value="Some Bepari do grading others do not">Some Bepari do grading others do not</option>
                      <option value="Overall, most Bepari do grading">Overall, most Bepari do grading</option>
                      <option value="Very few Bepari do grading">Very few Bepari do grading</option>
                    </select>
                  </div>
                </div>

                <div class="row">
                <label class="control-label col-md-12" id="label6">How much you are interested in private sector engagement?</label>
                  <div class="col-md-2" style="margin: 0px 0px 20px 0px;">
                    <select type="text" id="private_sector_interest" class="form-control resetSelect" value="" style="border-radius: 5px;border:2px solid #898AEE;">
                      <option value="" selected disabled> Select Option</option>
...
<!-- this page js -->
<script src="{{ asset('scripts/kii_checklist/entry_kii_bepari.js') }}"></script>
<!-- datepicker -->
<script src="{{ asset('plugins/datepicker/jquery-ui.js') }}"></script>

<script>

document.title = 'Kii Checklist Bepari';
