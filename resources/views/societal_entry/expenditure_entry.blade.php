...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">Monthly expenditure of the community</h1>
          </div><!-- /.col -->
        ...
        <div class="row">
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="form-group" id="table_div">
                <div class="row">
                  <div class="col-md-12" style="margin: 0px 0px 10px 0px;">
                    <h5>Section B1.2.4.	Monthly expenditure of the community</h5>
              ...
              <div class="row">
                  <div class="col-md-8" style="margin: 0px 0px 10px 0px;">
                    <h5>Section B1.2.5.	Major areas of monthly expenditure </h5>
                      ...
                      <table width="100%" class="table table-bordered table-striped table-hover tableFixHead" id="my_table2">
                        <thead>
                          <tr style="background-color: #8ed6f2;">
                            ...
                            <th style="text-align: center;">Education of Family Members</th>
                            <th style="text-align: center;">Savings</th>
                            <th style="text-align: center;">Investment for Occupation/Business</th>
                            <th style="text-align: center;">Clothing</th>
                            <th style="text-align: center;">Debt Repay</th>
          ...
          <hr style="border-bottom: 2px solid black;">
            <div class="row">
              ...
              <div class="col-md-2" style="margin: 10px 0px 10px 0px;">
                <a href="{{ route('View.Income.Entry') }}" style="color: black;">
                  <button type="submit" class="btn btn-info" style="width: 100%;border-radius: 20px;">Previous : Societal Income</button>
                </a>
              </div>
              ...
              <div class="col-md-2" style="margin: 10px 0px 10px 0px;">
                <a href="{{ route('View.Economic.Entry') }}">
                  <button type="submit" class="btn btn-info" style="color: black;width: 100%;border-radius: 20px;">Next : Societal Economic</button>
                </a>
              </div>
...
<!-- this page js -->
<script src="{{ asset('scripts/societal_entry/expenditure_entry.js') }}"></script>
<!-- datepicker -->
