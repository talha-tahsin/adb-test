...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">Entry: Land Tenure and Distribution</h1>
          </div><!-- /.col -->
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="form-group" id="table_div">
                    <div class="row">
                        ...
                        <h5>Section B1.1.3.	Land Tenure and distribution</h5>
                          <table width="100%" class="table table-bordered table-striped table-hover tableFixHead" id="voucher_table">
                            <thead>
                              <tr style="background-color: #8ed6f2;">
                                ...
                                <th rowspan="2" style="text-align:center;">Total land under Holding (acre)</th>
                                <th colspan="6" style="text-align:center;">Available type ( in acre) of the productive land in para</th>
                                <th rowspan="2" style="text-align:center;">Profit Distribution</th>
                                <th rowspan="2" style="text-align:center;">Action</th>
                              </tr>

                              <tr style="background-color: #99ccff;">
                                  <th style="text-align:center;border-bottom: none;">Land less (Nos. of HHs)</th>
                                  <th style="text-align:center;border-bottom: none;">Self -owned  (Nos. of HHs)</th>
                                  <th style="text-align:center;border-bottom: none;">Community land (acre)</th>
                                  <th style="text-align:center;border-bottom: none;">Lease (tenants) (Nos. of HHs)</th>
                                  <th style="text-align:center;border-bottom: none;">Sharecropping (Nos. of HHs)</th>
                                  ...
                                  <th style="text-align:center;border-bottom: none;">Fringe</th>
            ...
            <div class="row">
              ...
              <div class="col-md-2" style="margin: 10px 0px 10px 0px;">
                <a href="{{ route('View.Entry.Household') }}" style="color: black;">
                  <button type="submit" class="btn btn-success" style="width: 100%;border-radius: 20px;"> Previous : Societal Household</button>
                </a>
              </div>
              ...
              <div class="col-md-2" style="margin: 10px 0px 10px 0px;">
                <a href="{{ route('View.Occupation.Entry') }}">
                  <button type="submit" class="btn btn-success" style="color: black;width: 100%;border-radius: 20px;">Next : Societal Occupation</button>
                </a>
              </div>
...
<!-- this page js -->
<script src="{{ asset('scripts/societal_entry/land_entry.js') }}"></script>
<!-- datepicker -->
