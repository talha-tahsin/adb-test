...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">Livelihood and Socio-economic Status</h1>
          </div><!-- /.col -->
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="form-group" id="table_div">
                <div class="row">
                    ...
                    <h5>Section B1.2.1.	Occupation of the Community People (number of people)</h5>
            ...
            <div class="row">
              ...
              <div class="col-md-2" style="margin: 10px 0px 10px 0px;">
                <a href="{{ route('View.Land.Entry') }}" style="color: black;">
                  <button type="submit" class="btn btn-info" style="width: 100%;border-radius: 20px;">Previous : Societal Land</button>
                </a>
              </div>
              ...
              <div class="col-md-2" style="margin: 10px 0px 10px 0px;">
                <a href="{{ route('View.Livelihood.Entry') }}">
                  <button type="submit" class="btn btn-info" style="color: black;width: 100%;border-radius: 20px;">Next : Societal Livelihood</button>
                </a>
              </div>
...
<!-- this page js -->
<script src="{{ asset('scripts/societal_entry/occupation_entry.js') }}"></script>
<!-- datepicker -->
