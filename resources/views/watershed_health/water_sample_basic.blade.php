...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">Water Quality Test Basic Info Entry </h1>
          </div><!-- /.col -->
            ...
            <div class="card card-primary card-outline">
              ...
              <div class="col-md-12">
                <label class="control-label"><span style="color: green;">★&nbsp;</span> 
                  Show All Water Sample list according to avobe watershed:
                </label>
                ...
                <table width="100%" class="table table-bordered table-striped datatable dtr-inline" id="my_table2">
                  <thead>
                    <tr style="background-color: #6bbfd9;">
                      ...
                      <th style="text-align: center;width: 5%;">Sample ID</th>
                      ...
                      <th style="text-align: center;width: 6%;">Approx. Area</th>
                      <th style="text-align: center;width: 6%;">Farmer</th>
...
<!-- this page js -->
<script src="{{ asset('scripts/watershed_health/water_sample_basic.js') }}"></script>
<!-- datepicker -->
...
document.title = 'water quality test basic';
