...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">Patient Medical Test Entry</h1>
          </div><!-- /.col -->
                ...
                <div class="form-group" style="margin: 0px 0px 30px 0px;">
                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3" style="margin: 10px 0px 10px 0px;">
                      ...
                      <span style="color: red;">★&nbsp;</span>Receipt Date</label>
                    ...
                    <div class ="col-md-3" style="margin: 10px 0px 10px 0px;">
                      <label class="control-label validate" for="test_by">
                      <span style="color: red;">★&nbsp;</span>Test By </label>

                      <select id="test_by" name="test_by" class="custom-select form-control" style="border-radius: 5px;border:2px solid #898AEE;">
                      </select>
                    </div>
                  ...
                  <div class="card-body">
                      ...
                      <div class="row">
                        ...
                        <div class ="col-md-10" id="radioDiv" style="margin: 10px 0px 0px 0px;">
                          ...
                          <label class="control-label validate">Admit Patient ? 
                            &nbsp;&nbsp;</label>
                            <label class="radio">
                            <input type="radio" name="optradio" class="is_admit" value="0" checked>&nbsp;No &nbsp;&nbsp;</label>
                            <label class="radio">
                            <input type="radio" name="optradio" class="is_admit" value="1">&nbsp;Yes</label>
                          <!-- <input class="form-check-input" id="is_admit" value="1" type="checkbox" style="margin: 7px 0px 0px 0px;"> -->
                        </div>
                      </div>
                      ...
                      <div class="col-md-1"></div>
                        ...
                        <div class ="col-md-10" style="margin: 10px 0px 20px 0px;">
                          <label class="control-label validate" for="patient_list">
                          <span style="color: red;">★&nbsp;</span>Patient Name/Id </label>

                          <select id="patient_id" name="patient_id" class="custom-select form-control" style="border-radius: 5px;border:2px solid #898AEE;">
                          </select>
                        </div>
                      ...
                      <div class="row">
                        <div class="col-md-1"></div>
                        <div class="col-md-10" style="margin: 10px 0px 20px 0px;">
                          <button type="submit" class="btn btn-info" id="get_details" style="width: 100%;border-radius: 20px;color: black;">Get Patient Details</button>
                        </div>
                      </div>
              ...
              <div class="card card-info card-outline">
                <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="row">
                        <div class="col-md-1"></div>
                        <div class="col-md-10" style="margin: 10px 0px 30px 0px;">
...
<!-- this page js -->
<script src="{{ asset('js/receipt_entry.js') }}"></script>
<!-- datepicker -->
