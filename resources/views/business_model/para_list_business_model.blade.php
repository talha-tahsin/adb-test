...
<!-- Content Header (Page header) -->
    <div class="content-header" style="margin: 0px 0px -15px 0px;">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0" style="font-family: Serif;">Para List for Business Model</h1>
          </div><!-- /.col -->
                ...
                <table width="100%" class="table table-bordered table-striped datatable dtr-inline" id="my_table">
                  <thead>
                    <tr style="background-color: #6bbfd9;">
                      ...
                      <th style="text-align: left;width: 5%;">Para Name</th>
...
<!-- this page js -->
<script src="{{ asset('scripts/business_model/para_list_business_model.js') }}"></script>
<!-- datepicker -->
