                ...
                <div class="card-body">
                    ...
                    <form id="my_form" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="text" id="name" name="name" class="form-control @error('name') is-invalid @enderror initialVal" value="{{ old('name') }}" autocomplete="name" autofocus>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-6">
                                <input type="password" id="password" name="password" class="form-control @error('password') is-invalid @enderror initialVal" autocomplete="current-password">
