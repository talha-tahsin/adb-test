...
$(document).ready(function () {
    ...
    myTable1 = {
        '001' : 'Days the products remain with you',
        '002' : 'Selling price of product (Per unit cost in BDT)',
        '003' : 'Percentage increase in price from Buying to selling (%)',
        '004' : 'Average daily mobility in km',
        '005' : 'How many days does the product remain with you?',
    };
...
$('#product_processing').on('change', function(){

    var product_processing = $('#product_processing option:selected').val();

    if(product_processing == 'Yes'){
...
$(document).on('click', '#btn_store', function () {
    ...
    var bepari_name = $('#bepari_name').val();
    var bepari_cell_no = $('#bepari_cell_no').val();
    var age = $('#age').val();
    ...
    v_master = '<row>';
        ...
        v_master += '<bepari_name>' + bepari_name + '</bepari_name>';
        v_master += '<bepari_cell_no>' + bepari_cell_no + '</bepari_cell_no>';
    ...
    var answer1 = $('#product_processing option:selected').val();
    var answer2 = $('#product_source').val();
    var answer3 = $('#supply_terget').val();
    var answer4 = $('#product_wastage').val();
    var answer5 = $('#gardingOf_product option:selected').val();
    var answer6 = $('#private_sector_interest option:selected').val();
    ...
    xml_data2 += '<head>';
        ...
        xml_data2 += '<question>' + question1 + '</question>';
            if(answer1 == 'Yes'){
                var answer1 = $('#cost_of_perUnit_processing').val();
