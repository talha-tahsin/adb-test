...
$(document).ready(function () {
    ...
    myTable1 = {
        '001' : 'Hazard/Disaster Occurrence',
        '002' : 'Impact of Hazards',
        '003' : 'Actual amount (kg or ton) of processed goods per day',
        '004' : 'Selling unit price in BDT after processing (if applicable)',
        '005' : 'Percentage increase in price (if applicable)',
        '006' : 'Days the products remain with you',
    };
...
$(document).on('click', '#btn_store', function () {
    ...
    $.ajax({
        url: "/store_processing_agent_info",
        type: "POST",
