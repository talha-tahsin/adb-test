...
$(document).ready(function () {
    ...
    myTable1 = {
        '001' : 'Disaster/ Hazard',
        '002' : 'Impact of Hazards',
        '003' : 'Average percentage increase in input cost (for the retailer/seller) due to Hazards',
        '004' : 'Average percentage increase in input price (farmers buying price)',
...
$(document).on('click', '#btn_store', function () {
    ...
    var distanceOf_supplier = $('#distanceOf_supplier').val();
    ...
    v_master = '<row>';
        ...
        v_master += '<distanceOf_supplier>' + distanceOf_supplier + '</distanceOf_supplier>';
        v_master += '<input_names>' + input_names + '</input_names>';
