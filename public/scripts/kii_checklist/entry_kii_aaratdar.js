...
$(document).ready(function () {
    ...
    myTable1 = {
        '001' : 'Product stored in which months',
        '002' : 'Hazard/ Disaster Occurrence',
        '003' : 'Impact of Hazards',
        '004' : 'Average damage of revenue (%)',
        '005' : 'Buying price of unit product in BDT (if applicable)',
        '006' : 'Selling price of unit product in BDT (if applicable)',
        '007' : '% increase in price (if applicable)',
        '008' : 'Commission price (BDT)',
        '009' : 'Days the products remain with you',
    };
...
$(document).on('click', '#btn_store', function () {
    ...
    var aaratdar_name = $('#aaratdar_name').val();
    ...
    v_master = '<row>';
        ...
        v_master += '<aaratdar_name>' + aaratdar_name + '</aaratdar_name>';
